#------------------------------------------------------
#	BASE DE DATOS Jardineria de Teis
#-------------------------------------------------------------------------------------------------------------------
...
#   ofiEmpleado         clave foranea,
#   Jefe                clave foranea, 
#------------------------------------------------------
#	EMPLEADO 		= {Empleado}													                    *Información del Empleado*
#	Empleado 		= @idEmpleado + NombreEmpleado + PrimerApellido + (SegundoApellido) 
#                     Extension + (Email) + (Puesto) + (ofiEmpleado) + (Jefe)                           *Información de cada Empleado de la jardineria*
...
#   ofiEmpleado     = digito                                                                            *Identificador de la Oficina donde trabaja el Empleado y clave foranea*
...
#   gamaProducto    = digito                                                                            *Identificador de Gama asociada y clave foranea*
#------------------------------------------------------
...
#                       + (DireccionCliente2) + (repVentas)                                             *Información de cada Cliente de la jardineria*
...
#   clientePedido       clave foranea, no puede ser nulo
#------------------------------------------------------
#	PEDIDO 		    = {Pedido}													                        *Información de los Pedidos*
#	Pedido 		    = @idPedido + FechaPedido + FechaEsperada + (FechaEntrega) 
#                     Estado + (Comentario) + clientePedido                                             *Información de cada Pedido de la jardineria*
...
#   clientePedido   = digito                                                                            *Identificador de Cliente asociado y clave foranea*
#------------------------------------------------------
...
#   refPedido       = digito                                                                            *Identificador de pedido asociado y clave foranea*
#   refProducto     = digito                                                                            *Identificador de producto asociado y clave foranea*
#------------------------------------------------------
...
#   clientePago         clave foranea, no puede ser nulo
#------------------------------------------------------
#	PAGO 		    = {Pago}													                        *Información de la transaccion de Pago*
#	Pago 		    = @idPago + FormaPago + FechaPago + TotalAbonado + clientePago                	    *Información de cada Pago abonado a la jardineria*
...
#   clientePago     = digito                                                                            *Identificador de Cliente asociado y clave foranea*
#------------------------------------------------------
