...
public class Brunosbox {
        public static void main(String[] args) {
                ...
                System.out.println("\t FINAL SCORE: " +
                                whiteScoreCard.getRedBoxerFinalScore() +
                 ...
                 * System.out.println("\n\t knockdown round\t" +
                 * knockdownRound.getRedBoxerScore() +
                 ...
                 * System.out.println("\n\t points deducted round\t" +
                 * deducted.getRedBoxerScore() +
                ...
                /*
                 * PointsDeducted pointsDeducted = (PointsDeducted)
