...
class NotaController
{
    ...
    public string $view;
    private INotaServicio $usuarioServicio;
    ...
    public function __construct()
    {
        ...
        $this->page_title = '';
        $this->usuarioServicio = new NotaServicio();
    }
    ...
    public function list()
    {
        ...
        return $this->usuarioServicio->getNotas();
    }
    ...
    public function edit($id = null)
    {
        ...
        if (isset($_GET["id"])) {
            ...
            $nota = $this->usuarioServicio->getNoteById($id);
        } else {
            //para creación
            $nota = new Nota();
        }
    ...
    public function save()
    {
        ...
        $notaGuardada = $this->usuarioServicio->save($nota);
    ...
    public function confirmDelete()
    {
        ...
        return $this->usuarioServicio->getNoteById($_GET["id"]);
    }
    ...
    public function delete(): bool
    {
        ...
        return $this->usuarioServicio->deleteNoteById($_POST["id"]);
    }
}
