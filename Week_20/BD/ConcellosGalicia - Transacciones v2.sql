...
#	Creación del primer punto de Restauración
#	Creación del segundo punto de Restauración
#	Mostramos todos los datos introducidos
#	Restauramos en el ---- punto de Restauración
#	Mostramos todos los valores de la tabla
#	Introducimos los valores faltantes (podemos mostrar los valores de la tabla)
#	Borramos todos los valores de la tabla
#	Mostramos los datos de la tabla
#	Introducimos todos los valores
#	Confirmamos los valores introducidos
...
ROLLBACK TO SAVEPOINT punto_de_guardado_3;
	SELECT * FROM Comarca;
